...
// GetURL provides a mock function for the type URLGetter
func (_mock *URLGetter) GetURL(alias string) (string, error) {
...
func (_c *URLGetter_GetURL_Call) Return(s string, err error) *URLGetter_GetURL_Call {
	_c.Call.Return(s, err)
	return _c
}

func (_c *URLGetter_GetURL_Call) RunAndReturn(run func(alias string) (string, error)) *URLGetter_GetURL_Call {
	_c.Call.Return(run)
	return _c
}
